...
- **Edge strain** — in a hard curve the strained edge of the path brightens as openpilot nears its
  steering-torque limit. Early, directional, and silent — the fix for "you only find out at the alert."
